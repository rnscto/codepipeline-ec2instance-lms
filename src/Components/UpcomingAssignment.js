                       ...
                       <div className='col-12'>
                         <div className='card p-3 border-0 mb-3'>
                          <div className='text-start py-2' style={{ fontSize:20, fontWeight:600 }}>{item.name}</div>
                           ...
                           <NavLink to="/SubmitAssignments" className="text-decoration-none mt-3"  >
                            <button type='button' className='btn btn-outline py-2' style={{ width:"100%", border:'1px solid #ED7A2B', color:"#ED7A2B", borderRadius:5 }} >Submit Assignment</button>
                           </NavLink>
                         </div>
                       </div> 
                      </div>

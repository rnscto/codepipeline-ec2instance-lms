    ...
    <div>
      ...
      <div className='row mx-3 mt-5'>
        <NavLink to="/AssignmemtDeclared" className="text-decoration-none" >
          <div className='py-4' style={{ width:"100%", backgroundColor:"#ED7A2B", borderRadius:5, display:"flex", alignItems:'center', justifyContent:"center", cursor:"pointer", color:"#fff", fontSize:20 }} ><Document />&nbsp; Submit Assignments</div>
        </NavLink>
      </div>
      <div className='row mx-3 mt-5'>
        <div className='py-4' style={{ width:"100%", backgroundColor:"#DDE2EA", borderRadius:5, display:"flex", alignItems:'center', justifyContent:"center", cursor:"pointer", color:"#95A1B6", fontSize:20 }} ><FiUpload style={{ fontSize:25, }} />&nbsp; Upload Files</div>
      </div>
    </div>
  )
}
